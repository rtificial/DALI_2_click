...
//=================================================================
#include "qqqDALI.h"
#include <wiringPi.h> // Include the WiringPi library for Raspberry Pi

#ifdef DALI_DEBUG
#include "arduino.h"
#endif

// Define the GPIO pins for TX and RX
#define DALI_TX_PIN 5
#define DALI_RX_PIN 6
...
uint8_t Dali::rx(uint8_t *ddata) {
  ...
  case COMPLETED: 
    rxstate = EMPTY;   
    uint8_t dlen = _man_decode((uint8_t*)rxdata,rxpos*8,ddata);
